...
import { getRegardingObject } from './utils';

const regardingObject = getRegardingObject();
...
class PageContextProvider extends Component {
    ...
    handleFetchData = ({ pageSize, pageNumber }) => {
        ...
        apiServiceUtility.handleFetchData({ payload, onShowMessager: this.context.onShowMessager, setState: this.setState, regardingObject });
    }
