                ...
                >
                    ...
                    >
                        <div style={{ padding: 15 }}>
                            ...
                            <FormField name="name" label="Nama Orang Tua :" style={{ marginBottom: 10 }}>
                        ...
                        <div style={{ padding: 15 }}>
                            ...
                            <FormField name="parentStatus" label="Status Hubungan :" style={{ marginBottom: 10 }}>
                                <ComboBox value={formModel.parentStatus} data={staticData.parentStatus} disabled={isSaving}></ComboBox>
                            </FormField>
                        </div>
                    </Box>
