...
import { getChildStatusObject } from './utils';

const childStatusObject = getChildStatusObject();
...
class PageContextProvider extends Component {
    ...
    handleFetchData = ({ pageSize, pageNumber }) => {
        ...
        apiServiceUtility.handleFetchData({ payload, onShowMessager: this.context.onShowMessager, setState: this.setState, childStatusObject });
    }
