        ...
        >
            ...
            >
                ...
                <GridColumn field="attachment" title="Informasi" render={({ value, row }) => {
                    return (<span>Hasil <b>{row.notificationType === 'EE' ? 'Export Data Karyawan' : 'Export Laporan Skorsing'}</b> sudah dapat di unduh: <a href={`http://localhost:8080/export/${value}`}>{value}</a></span>);
                }}></GridColumn>
            </DataGrid>
        </Dialog>
    )
